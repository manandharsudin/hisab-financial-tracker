...
.hisab-type-savings { background-color: #e7f3ff; color: #0073aa; }
.hisab-type-current { background-color: #fff2cc; color: #996633; }
.hisab-type-credit_card { background-color: #fce4ec; color: #c2185b; }
.hisab-type-fixed_deposit { background-color: #e8f5e8; color: #2e7d32; }

.hisab-currency-badge {
    display: inline-block;
    padding: 4px 8px;
    border-radius: 3px;
    font-size: 11px;
...
.hisab-currency-npr { background-color: #e3f2fd; color: #1976d2; }
.hisab-currency-usd { background-color: #f3e5f5; color: #7b1fa2; }
...
.hisab-account-actions {
    display: flex;
    gap: 5px;
    flex-wrap: wrap;
}

.hisab-account-actions .button {
    font-size: 11px;
    padding: 4px 8px;
    height: auto;
    line-height: 1.4;
