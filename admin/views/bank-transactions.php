...
.hisab-type-deposit { background-color: #e8f5e8; color: #2e7d32; }
.hisab-type-withdrawal { background-color: #ffebee; color: #c62828; }
.hisab-type-phone_pay { background-color: #e3f2fd; color: #1976d2; }
.hisab-type-transfer_in { background-color: #f3e5f5; color: #7b1fa2; }
.hisab-type-transfer_out { background-color: #fff3e0; color: #f57c00; }

.hisab-reference-badge, .hisab-phone-pay-badge {
    display: inline-block;
    padding: 2px 6px;
...
.hisab-phone-pay-badge {
    background-color: #e3f2fd;
    color: #1976d2;
}

.hisab-transaction-actions {
    display: flex;
    gap: 5px;
    flex-wrap: wrap;
}

.hisab-transaction-actions .button {
    font-size: 11px;
    padding: 4px 8px;
    height: auto;
    line-height: 1.4;
